...
sed -i.bak -e "s|^address *= \"0\.0\.0\.0:9090\"$|address = \"0\.0\.0\.0:9092\"|" node1/config/app.toml
sed -i -e "s|^address *= \"0\.0\.0\.0:9091\"$|address = \"0\.0\.0\.0:9093\"|" node1/config/app.toml
sed -i -e "s|laddr = \"tcp:\/\/127.0.0.1:26657\"|laddr = \"tcp://127.0.0.1:10002\"|" node1/config/config.toml
sed -i -e "s|^pprof_laddr *= \"localhost:6060\"|pprof_laddr = \"localhost:6062\"|" node1/config/config.toml
sed -i -e "s|^laddr *= \"tcp:\/\/0\.0\.0\.0:26656\"|laddr = \"tcp:\/\/0\.0\.0\.0:20002\"|" node1/config/config.toml
